...
export class ProductService {
  ...
  private baseUrl = 'http://35.190.161.185:8080/api/v1/product';
  ...
  saveComment(comment: Comments): Observable<Object> {
    return this.http.post(`http://35.190.161.185:8080/api/v1/comments`, comment);
  }
  ...
  deleteComments(id: number): Observable<any> {
    return this.http.delete(`http://35.190.161.185:8080/api/v1/comments/${id}`, { responseType: 'text' });
  }
  ...
  getCommentsList(id: number): Observable<any> {
    return this.http.get(`http://35.190.161.185:8080/api/v1/comments/all-users-comments/${id}`);
  }
  ...
  getAllComments(id: number): Observable<any> {
    return this.http.get(`http://35.190.161.185:8080/api/v1/comments/all-comments/${id}`);
  }
}
